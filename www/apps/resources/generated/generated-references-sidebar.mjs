const generatedgeneratedReferencesSidebarSidebar = {
  ...
  "items": [
    ...
    },
    {
      ...
      "description": "Resources you can access through the Medusa and Module containers.",
      "children": []
    },
    {
      "loaded": true,
      ...
      "description": "Built-in workflows and steps you can use in your customizations.",
      "children": [
        {
          "loaded": true,
          "isPathHref": true,
    ...
    },
    {
      ...
      "description": "List of methods in your service extending the service factory.",
      "children": [
        {
          "loaded": true,
          "isPathHref": true,
...
export default generatedgeneratedReferencesSidebarSidebar