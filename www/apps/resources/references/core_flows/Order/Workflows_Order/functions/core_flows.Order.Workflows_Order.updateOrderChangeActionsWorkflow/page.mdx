---
slug: /references/medusa-workflows/updateOrderChangeActionsWorkflow
sidebar_label: updateOrderChangeActionsWorkflow
sidebar_description: Update one or more order change actions.
tags:
  - order
  - workflow
---
...
<SourceCodeLink link="https://github.com/alse-sym/medusa/blob/84ffdab81b1701b2db2ae3ff1df5f42d861308f0/packages/core/core-flows/src/order/workflows/update-order-change-actions.ts#L23" />
...
<WorkflowDiagram workflow={{"name":"updateOrderChangeActionsWorkflow","steps":[{"type":"step","name":"updateOrderChangeActionsStep","description":"This step updates order change actions.","link":"../../../Steps_Order/functions/core_flows.Order.Steps_Order.updateOrderChangeActionsStep/page.mdx","depth":1}]}} />

## Input

<TypeList types={[{"name":"UpdateOrderChangeActionDTO[]","type":"[UpdateOrderChangeActionDTO](../../../../../order/interfaces/order.UpdateOrderChangeActionDTO/page.mdx)[]","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"id","type":"`string`","description":"The ID of the order change action.","optional":false,"defaultValue":"","expandable":false,"children":[]},{"name":"internal_note","type":"`null` \\| `string`","description":"The internal note of the order change action.","optional":true,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="updateOrderChangeActionsWorkflow"/>
