...
import { updateInventoryItemsStep } from "@medusajs/medusa/core-flows"

const myWorkflow = createWorkflow(
  "my-workflow",
  () => {
    const data = updateInventoryItemsStep({
      "id": "id_7LvECKmtvkARenoIEsh"
    })
  }
)
```
