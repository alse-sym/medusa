...
<SourceCodeLink link="https://github.com/alse-sym/medusa/blob/84ffdab81b1701b2db2ae3ff1df5f42d861308f0/packages/core/core-flows/src/promotion/workflows/update-promotions.ts#L61" />
...
<WorkflowDiagram workflow={{"name":"updatePromotionsWorkflow","steps":[{"type":"step","name":"updatePromotionsStep","description":"This step updates one or more promotions.","link":"../../../Steps_Promotion/functions/core_flows.Promotion.Steps_Promotion.updatePromotionsStep/page.mdx","depth":1},{"type":"when","condition":"{\n      return !!promotionInputs.promotionsStatusUpdateInput?.length\n    }","depth":"2","steps":[{"type":"workflow","name":"updatePromotionsStatusWorkflow","description":"Update the status of one or more promotions.","link":"../core_flows.Promotion.Workflows_Promotion.updatePromotionsStatusWorkflow/page.mdx","depth":2}]},{"type":"hook","name":"promotionsUpdated","description":"This hook is executed after the promotions are updated. You can consume this hook to perform custom actions on the updated promotions.","link":"#promotionsUpdated","depth":3}]}} />
